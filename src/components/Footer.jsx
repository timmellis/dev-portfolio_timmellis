...
import BostonSkylineWhite from '../assets/boston-silhouette01-white.png'
import BostonSkylineOutline from '../assets/boston-silhouette01-outline.png'

function Footer(props) {
  return (
    <div className='footer-container'>
      
      <img src={BostonSkylineOutline} alt='' className='footer-img' />
      <div className='footer-text'>
        Designed and built by Tim Ellis &copy; 2022
        <br />
